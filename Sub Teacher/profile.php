...
$stmt->execute([$username]);  // Using $username for the logged-in sub teacher
$user_details = $stmt->fetch(PDO::FETCH_ASSOC);

// Check if sub teacher exists
if ($user_details) {
    ...
    // Handle the case where the sub teacher does not exist
    echo "Sub teacher details not found.";
}
...
<?php include('navbar.php'); ?>
    <div class="profile_container">
        ...
        <div class="buttons no-print">
            <a href="./edit_sub_teacher.php">Edit</a>
        </div>
