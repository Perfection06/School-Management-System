                ...
                <div>
                    ...
                    <div class="nav__list">
                        <div class="nav__items">
                            ...
                            <a href="./Staff_Dashboard.php" class="nav__link active">
                            ...
                            <a href="./events.php" class="nav__link active">
                                <i class='bx bx-user nav__icon' ></i>
                            ...
                            <div class="nav__dropdown">
                                ...
                                <div class="nav__dropdown-collapse">
                                    <div class="nav__dropdown-content">
                                        ...
                                        <a href="./view_messages.php" class="nav__dropdown-item">View Message</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="nav__dropdown">
                                ...
                                <div class="nav__dropdown-collapse">
                                    <div class="nav__dropdown-content">
                                        <a href="./add_grade.php" class="nav__dropdown-item">Add Grade</a>
                                        <a href="./add_subject.php" class="nav__dropdown-item">Add Subject</a>
                                        <a href="./assign_subjects.php" class="nav__dropdown-item">Assign subject to grade</a>
                                        <a href="./add_timeTable.php" class="nav__dropdown-item">Add Timetable</a>
                                        <a href="./view_classes.php" class="nav__dropdown-item">View Classes</a>
                                    </div>
                                </div>
                            </div>
