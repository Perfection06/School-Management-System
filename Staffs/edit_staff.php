...
// Fetch user details for the staff profile
$sql = "SELECT profile_image FROM staff WHERE username = ?";
...
if (isset($_FILES['profile_image']) && $_FILES['profile_image']['error'] === UPLOAD_ERR_OK) {
    ...
    if (move_uploaded_file($_FILES["profile_image"]["tmp_name"], $target_file)) {
        $sql_update_image = "UPDATE staff SET profile_image = ? WHERE username = ?";
